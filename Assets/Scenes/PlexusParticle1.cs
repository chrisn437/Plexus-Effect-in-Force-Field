...
public class PlexusParticle1 : MonoBehaviour
{
    ...
    //Create arraz that contains all particals
    ...
    void LateUpdate()
    {
        ...
        //when array has not been initialzed, then set it to max value
        //adjust array size if particals get bigger than array size
